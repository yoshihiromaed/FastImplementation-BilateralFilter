...
namespace nlmf
{
	void exTest_NLMF_AVX512()
	{
		...
		const string wname = "image NLMF AVX512";
		namedWindow(wname);
		...
		nonLocalMeansFilter_AVX512(src, ref, Size(tW, tW), Size(sW, sW), (double)h, BORDER_REPLICATE, WEIGHT_VECTOR_EXP);
#endif
...
#if CV_AVX512
				CalcTime t;
				nonLocalMeansFilter_AVX512(src, dest, Size(tW, tW), Size(sW, sW), (double)h, BORDER_REPLICATE, WEIGHT_VECTOR_EXP);
...
#if CV_AVX512
				CalcTime t;
				nonLocalMeansFilter_AVX512(src, dest, Size(tW, tW), Size(sW, sW), (double)h, BORDER_REPLICATE, WEIGHT_RANGE_LUT_SET);
				st.push_back(t.getTime());
				ci(t.getTimeString());
#else
				ci("invalid impl");
...
#if CV_AVX512
				CalcTime t;
				nonLocalMeansFilter_AVX512(src, dest, Size(tW, tW), Size(sW, sW), (double)h, BORDER_REPLICATE, WEIGHT_RANGE_QUANTIZATION_LUT_SETxN);
				st.push_back(t.getTime());
				ci(t.getTimeString());
#else
				ci("invalid impl");
...
#if CV_AVX512
				CalcTime t;
				nonLocalMeansFilter_AVX512(src, dest, Size(tW, tW), Size(sW, sW), (double)h, BORDER_REPLICATE, WEIGHT_RANGE_QUANTIZATION_LUT_SETx1);
				st.push_back(t.getTime());
				ci(t.getTimeString());
#else
				ci("invalid impl");
...
#if CV_AVX512
				CalcTime t;
				nonLocalMeansFilter_AVX512(src, dest, Size(tW, tW), Size(sW, sW), (double)h, BORDER_REPLICATE, WEIGHT_RANGE_LUT_GATHER);
				st.push_back(t.getTime());
				ci(t.getTimeString());
#else
				ci("invalid impl");
...
#if CV_AVX512
				CalcTime t;
				nonLocalMeansFilter_AVX512(src, dest, Size(tW, tW), Size(sW, sW), (double)h, BORDER_REPLICATE, WEIGHT_RANGE_QUANTIZATION_LUT_GATHERxN);
				st.push_back(t.getTime());
				ci(t.getTimeString());
#else
				ci("invalid impl");
...
#if CV_AVX512
				CalcTime t;
				nonLocalMeansFilter_AVX512(src, dest, Size(tW, tW), Size(sW, sW), (double)h, BORDER_REPLICATE, WEIGHT_RANGE_QUANTIZATION_LUT_GATHERx1);
				st.push_back(t.getTime());
				ci(t.getTimeString());
#else
				ci("invalid impl");
