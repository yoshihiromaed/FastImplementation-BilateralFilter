...
namespace grf
{
	void exTest_GRF_AVX()
	{
		...
		//gaussianRangeFilter_AVX(src, ref, Size(d, d), (double)sr, FILTER_RECTANGLE, BORDER_REPLICATE, WEIGHT_VECTOR_EXP);
#endif
		...
		while (true)
		{
			...
			case WEIGHT_VECTOR_EXP:
			{
				...
				else
				{
					...
					gaussianRangeFilter_AVX(src, dest, Size(d, d), (double)sr, FILTER_RECTANGLE, BORDER_REPLICATE, WEIGHT_VECTOR_EXP);
			...
			case WEIGHT_RANGE_LUT_SET:
			{
				...
				else
				{
					CalcTime t;
					// normal gaussianRange filter
					gaussianRangeFilter_AVX(src, dest, Size(d, d), (double)sr, FILTER_RECTANGLE, BORDER_REPLICATE, WEIGHT_RANGE_LUT_SET);
					st.push_back(t.getTime());
					ci(t.getTimeString());
				}
#else
			...
			case WEIGHT_RANGE_QUANTIZATION_LUT_SET:
			{
				...
				else
				{
					CalcTime t;
					// normal gaussianRange filter
					gaussianRangeFilter_AVX(src, dest, Size(d, d), (double)sr, FILTER_RECTANGLE, BORDER_REPLICATE, WEIGHT_RANGE_QUANTIZATION_LUT_SET);
					st.push_back(t.getTime());
					ci(t.getTimeString());
				}
#else
			...
			case WEIGHT_RANGE_LUT_GATHER:
			{
				...
				CalcTime t;
				// normal gaussianRange filter
				gaussianRangeFilter_AVX(src, dest, Size(d, d), (double)sr, FILTER_RECTANGLE, BORDER_REPLICATE, WEIGHT_RANGE_LUT_GATHER);
				st.push_back(t.getTime());
				ci(t.getTimeString());
#else
				ci("invalid impl");
			...
			case WEIGHT_RANGE_QUANTIZATION_LUT_GATHER:
			{
				...
				CalcTime t;
				// normal gaussianRange filter
				gaussianRangeFilter_AVX(src, dest, Size(d, d), (double)sr, FILTER_RECTANGLE, BORDER_REPLICATE, WEIGHT_RANGE_QUANTIZATION_LUT_GATHER);
				st.push_back(t.getTime());
				ci(t.getTimeString());
#else
				ci("invalid impl");
